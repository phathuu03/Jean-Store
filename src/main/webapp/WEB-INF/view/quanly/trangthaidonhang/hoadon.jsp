...
<div class="pagination-container d-flex justify-content-center mt-4">
    ...
    <c:if test="${currentPage > 0}">
        <a href="/view-trang-thai-don-hang?page=0&size=15&search=${search}" class="btn btn-outline-primary me-2">Trang đầu</a>
    </c:if>

    <!-- Trang trước -->
    <c:if test="${currentPage > 0}">
        <a href="/view-trang-thai-don-hang?page=${currentPage - 1}&size=15&search=${search}" class="btn btn-outline-primary me-2">Trang trước</a>
    </c:if>
    ...
    <c:if test="${currentPage < totalPages - 1}">
        <a href="/view-trang-thai-don-hang?page=${currentPage + 1}&size=15&search=${search}" class="btn btn-outline-primary me-2">Trang tiếp theo</a>
    </c:if>

    <!-- Trang cuối -->
    <c:if test="${currentPage < totalPages - 1}">
        <a href="/view-trang-thai-don-hang?page=${totalPages - 1}&size=15&search=${search}" class="btn btn-outline-primary">Trang cuối</a>
    </c:if>
